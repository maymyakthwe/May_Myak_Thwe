...
const Main =()=>{
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    >
        {/* nav bar */}
        <div  className='fixed pt-[20px] xl:pt-[40px] w-screen  whitespace-nowrap text-center  text-xl text-[#f3f3f3]  xl:px-[100px] z-[1000] border-b-1 border-[#222] py-[30px] bg-[#111] sm:px-[50px] px-[20px]'>
            <NavBar/>
            </div>
      <motion.div
      
      className='pt-[120px] md:px-[20%] py-[100px] px-[15%] '>
      <div>
          {/* Header */}
